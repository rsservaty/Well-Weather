...
function initMap() {
    ...
    const layerVoyager = L.tileLayer('https://{s}.basemaps.cartocdn.com/rastertiles/voyager/{z}/{x}/{y}{r}.png', { attribution: attr, maxZoom: 19 });
    const layerLight   = L.tileLayer('https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}{r}.png',           { attribution: attr, maxZoom: 19 });
    const layerDark    = L.tileLayer('https://{s}.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}{r}.png',            { attribution: attr, maxZoom: 19 });
    layerVoyager.addTo(map);
    L.control.layers({ 'Voyager': layerVoyager, 'Hell': layerLight, 'Dunkel': layerDark }, {}, { position: 'topright', collapsed: true }).addTo(map);
